...
[chunkSize, featureType, numFeatureMatch, flatSamples, flatPath, cpdPath, ...
    resultPath] = load_cfg(cfgPath, 'param.chunkSize', ...
    'param.cpd.featureType', 'param.cpd.numFeatureMatch', ...
    'data.flatSamples', 'path.flat', 'path.cpd', 'path.cpdJobMats'); 
...
for k1=1:length(flatSamples)
    for k2=1:length(flatSamples)
        ...
        scriptText = [' cPdist_landmarkfree_ongrid ' ...
            filename1 ' ' ...
            filename2  ' ' ...
