...
[fiberEps, chunkSize, flatSamples, cpdMstPath, softenPath, resultPath] = ...
    load_cfg(cfgPath, 'param.diff.fiberEps', 'param.chunkSize', ...
    'data.flatSamples', 'path.cpdMST', 'path.soften', 'path.softenJobMats');
